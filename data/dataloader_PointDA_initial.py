# without metasets processing
import os
import glob
import h5py
import numpy as np
from torch.utils.data import Dataset
from utils.pc_utils_Norm import (farthest_point_sample_no_curv_np, scale_to_unit_cube, jitter_pointcloud,
...
class ScanNet(Dataset):
    ...
    def __getitem__(self, item):
        ...
        if pointcloud.shape[0] > NUM_POINTS:
            ...
            _, pointcloud = farthest_point_sample_no_curv_np(pointcloud, NUM_POINTS)
